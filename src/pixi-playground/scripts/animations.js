(function () {
  ...
  var Resource = function (url) {
    ...
    this.sprite = (function () {
      var sprite = new PIXI.Sprite(PIXI.Texture.fromImage(url));
  ...
  var firstSlide = (function () {
    var flowerPot = new Resource('.assets/slide-1/flower-pot.png');
    ...
    var macbook = new Resource('.assets/slide-1/macbook.png');
    ...
    var sketchbook = new Resource('.assets/slide-1/sketchbook.png');
    ...
    var watch = new Resource('.assets/slide-1/watch.png');
    ...
    return AnimationResourceGroup([flowerPot, macbook, sketchbook, watch]);
  })();

  var secondSlide = (function () {
    var imac = new Resource('.assets/slide-2/imac.png');
    ...
    var iphone = new Resource('.assets/slide-2/iphone.png');
    ...
    var sketchpad = new Resource('.assets/slide-2/sketchpad.png');
    ...
    return AnimationResourceGroup([imac, iphone, sketchpad]);
  })();

  var third = (function () {
    var imac = new Resource('.assets/slide-3/imac.png');
    ...
    var iphone = new Resource('.assets/slide-3/iphone.png');
    ...
    return AnimationResourceGroup([imac, iphone]);
  })();
})();
