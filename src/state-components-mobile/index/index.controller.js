(function () {
  ...
  angular
    ...
    .controller('IndexCtrl', ['$scope', '$state', '$window', 'PARSED_UA', function ($scope, $state, $window, PARSED_UA) {
      ...
      $scope.onInit = onInit;
      $scope.footerText = '<p class="small-and-medium-only"><span class="normal-content">More on our <strong>Social Sites</strong></span><span class="special-content">More projects on our <strong>Social Networks</strong></span></p><p class="large-only">Find more projects on our <strong>Social Networks</strong></p>';
      $scope.slidesHtml = [
