    ...
    .run(['$rootScope', function ($rootScope) {
      $rootScope.str = {
        ...
        ourProcesses: {
          ...
          firstColumn: '<p><strong>Product Design. </strong>Building a successful app or site requires more than a great, well timed idea - it requires careful planning and execution. We\'re here to help with the latter two.</p><p>We understand each project is unique so instead of jumping to the easiest solution, we are going to spend some time understanding who you are, what it is you are trying to achieve and who is the target market for your product. We will then ink out a basic structure for the product and start planning its execution. From a front-end perspective, this usually involves defining the structure for each section or page, creating the designs and coding the interface up. As far as the back end is concerned, we will establish the logic early on, and develop the platform modularly.</p>',
        ...
        mobile: {
          expertise: '<p>Thank you for stopping by our site. We are a creative agency specialising in UI/UX and Development.</p><p>We believe good <strong>UI</strong> is one that makes sense to the people using it: one that is adequate, beautiful, logical and empathetic towards the user. We also believe technology should be simple and improve people\'s lives in natural, almost invisible ways. To achieve this, we look at the whole picture and try to plan ahead as clearly as possible - when every detail has its place and purpose, creativity and function come together naturally.</p><p>UI and UX however, are just the tip of the iceberg, with the <strong>code</strong> being the one that breathes life into an app and making everything tick. Because of this, writing good code is of paramount importance. Every project requires careful planning and a solid understanding of the tools available at our disposal.</p>',
