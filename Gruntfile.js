    ...
    filesize: {
      base: {
        ...
        options: {
          output: [{
            stdout: false,
            path: '<%= yeoman.app %>/common/preloader/files-to-preload.constant.js',
    ...
    filetransform: {
      options: {
        map: function (contents) {
          ...
          for (var i = 0; i < files.length; i++) {
            ...
            if (fileSplit[0].length > 0) {
              ...
              if (fileSplit[0].match(/\@2x\./gi) === null) {
                toReturn.totalSize += fileSplit[1];
        ...
        reduce: function (results) {
          var
            start = '/* jshint ignore:start */\r\n\r\n/* this file is dynamically generated by filetransform */\r\n\r\n(function () {\'use strict\';angular.module(\'common.preloader\').constant(\'FILES_TO_PRELOAD\', ',
            end = ');})();\r\n\r\n/* jshint ignore:end */';
      ...
      files: {
        src: '<%= yeoman.app %>/common/preloader/files-to-preload.constant.js',
        dest: '<%= yeoman.app %>/common/preloader/files-to-preload.constant.js'
      },
    },
